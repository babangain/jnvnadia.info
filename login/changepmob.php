...
<h1>Change Parent Mobile</h1>
<h2>Enter New Mobile No :</h2>
<input id="input" name="input" type="text"></input><br/>
<input type="submit" value="Change Parent Mobile Number"></input></form>

<?php
$input=$_POST['input'];
if($input==""){;}
else {
$sql0="UPDATE user SET pmob='$input' WHERE admno=$admno";
if(mysqli_query($conn, $sql0)){ echo "<script>alert('Parent Mobile No. Changed Succesfully');</script>";
}
