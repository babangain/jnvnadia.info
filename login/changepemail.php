...
<h1>Change Parent Email</h1>
<h2>Enter New Email :</h2>
<input id="input" name="input" type="text"></input><br/>
<input type="submit" value="Change Parent Email"></input></form>

<?php
$input=$_POST['input'];
if($input==""){;}
else {
$sql0="UPDATE user SET pemail='$input' WHERE admno=$admno";
if(mysqli_query($conn, $sql0)){ echo "<script>alert('Parent Email ID Changed Succesfully');</script>";
}
