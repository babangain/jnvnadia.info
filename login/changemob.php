...
<input type="submit" value="Change Mobile Number"></input></form>

<?php
$input=$_POST['input'];
if($input==""){;}
else {
$sql0="UPDATE user SET mob='$input' WHERE admno=$admno";
if(mysqli_query($conn, $sql0)){ echo "<script>alert('Mobile No. Changed Succesfully');</script>";
}
