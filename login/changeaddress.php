...
<input type="submit" value="Change Address"></input></form>

<?php
$input=$_POST['input'];
if($input==""){;}
else {
$sql0="UPDATE user SET address='$input' WHERE admno=$admno";
if(mysqli_query($conn, $sql0)){ echo "<script>alert('Address Changed Succesfully');</script>";
}
